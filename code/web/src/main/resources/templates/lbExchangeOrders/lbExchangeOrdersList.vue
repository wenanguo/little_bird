...
<script>
    ...
    import { getLbExchangeOrdersList, saveLbExchangeOrders, delLbExchangeOrders, batchDelLbExchangeOrders } from '@/api/lbExchangeOrders'
    import EditForm from './lbExchangeOrdersForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getLbExchangeOrdersList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveLbExchangeOrders(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelLbExchangeOrders(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delLbExchangeOrders(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
