...
<script>
    ...
    import { getLbProtocolList, saveLbProtocol, delLbProtocol, batchDelLbProtocol } from '@/api/lbProtocol'
    import EditForm from './lbProtocolForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getLbProtocolList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveLbProtocol(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelLbProtocol(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
