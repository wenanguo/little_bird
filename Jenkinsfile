pipeline {
    ...
    stages {
        ...
        //             args '-v /var/jenkins_home/python/.cache:/.cache'
        //             args '-v /var/jenkins_home/python/.local:/.local'
                    
        //         }
        //     }
        //     steps {
        //         //sh 'cd code && pip install -r requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple/ --user && python manage.py test'
        ...
        stage('Deliver') { 
            ...
            steps {
                ...
                sh "echo ok && pwd && ls -al && cd ../vue && docker build -t 118.126.66.51/wenanguo/little_bird_vue:v1.0.$BUILD_NUMBER -f Dockerfile-vue . && docker push 118.126.66.51/wenanguo/little_bird_vue:v1.0.$BUILD_NUMBER"
