...
<script>
    ...
    import { getLbReportList, saveLbReport, delLbReport, batchDelLbReport } from '@/api/lbReport'
    import EditForm from './lbReportForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getLbReportList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
            ...
            handleBatchDel () {
                batchDelLbReport(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
