    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="用户名"
          v-decorator="['username', {rules: [{ required: true, message: '请输入用户名' }], initialValue: 'wenanguo', validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      ...
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="邮箱"
          v-decorator="['email', {rules: [{ required: true, type: 'email', message: '请输入邮箱地址' }], initialValue: 'wenanguo@163.com', validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      ...
      <a-row :gutter="16">
        <a-col class="gutter-row" :span="16">
          <a-form-item>
            <a-input size="large" type="text" placeholder="验证码" v-decorator="['captcha', {rules: [{ required: true, message: '请输入验证码' }], initialValue: '123456', validateTrigger: 'blur'}]">
