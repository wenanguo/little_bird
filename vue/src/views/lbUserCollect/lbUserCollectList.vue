...
<script>
    ...
    import { getLbUserCollectList, saveLbUserCollect, delLbUserCollect, batchDelLbUserCollect } from '@/api/lbUserCollect'
    import EditForm from './lbUserCollectForm'
    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                loadData: parameter => {
                    ...
                    return getLbUserCollectList(requestParameters)
                        .then(res => {
                            return res.result
                        })
                },
        ...
        methods: {
                ...
                form.validateFields((errors, values) => {
                    if (!errors) {
                        ...
                        if (values.id > 0) {
                            ...
                            saveLbUserCollect(values).then(res => {
                                this.visible = false
            ...
            handleBatchDel () {
                batchDelLbUserCollect(this.selectedRowKeys).then(res => {
                    this.confirmLoading = false
                    // 刷新表格
                    this.$refs.table.refresh()
            ...
            handleDel (record) {
                if (record.id > 0) {
                    // 修改 e.g.
                    delLbUserCollect(record).then(res => {
                        this.confirmLoading = false
                        // 刷新表格
                        this.$refs.table.refresh()
